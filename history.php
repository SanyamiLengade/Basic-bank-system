...
<head>
    ...
    <style type="text/css">
        ...
        table {
            ...
            max-width: 100%;
            white-space: nowrap;
            background-image: url("Banking2.jpg");
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand" href="homePage.html">S P A R K S</a>
    ...
    <div class="my-info text-center">
        <button class="btn sendMoney" data-toggle="modal" data-target="#sendMoney"><a href="transfer.php ">Transfer Money</a></button>
